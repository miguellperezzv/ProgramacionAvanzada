...
public class ControladorTransacciones implements ActionListener{
	
	private VentanaTransacciones transacciones;

    public ControladorTransacciones(VentanaTransacciones transacciones) {
		...
		if(arg0.getSource()==transacciones.getbtnAnadir()) {
			...
			if(validez==true) {
				...
				transacciones.getModelo().insertarNuevaTransaccion(transacciones.getTextField_1().getText(), 
						...
						Double.parseDouble(transacciones.getTextField().getText()), 
